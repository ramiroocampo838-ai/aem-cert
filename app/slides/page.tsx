...
import { SlidesBrowser } from "@/components/slides/slides-browser"
    ...
    <div className="flex flex-col">
      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 max-w-3xl mx-auto w-full">
        <div className="mb-6 space-y-1">
          <h2 className="text-2xl font-bold tracking-tight">Slide Library</h2>
          <p className="text-muted-foreground text-sm">
            Browse available presentations and download them. New files are automatically detected.
          </p>
        </div>
